...
<!-- saved from url=(0038)http://www.0573fang.com/map/renthouse/ -->
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">

<title>地图找房 - 嘉论房产网</title>
...
<script async="" src="http://fex.bdstatic.com/hunter/alog/speed.min.js?v=160115"></script>
<script async="" src="http://fex.bdstatic.com/hunter/alog/dp.min.js?v=-17249-17249"></script>
<script async="" src="http://fex.bdstatic.com/hunter/alog/alog.min.js?v=-17249-17249"></script>
<script type="text/javascript">
var coord        = '121.481207,31.236573',
    siteurl    = 'http://www.0573fang.com/',
    tplurl        = '/statics/images/';
</script>
<script type="text/javascript" src="http://www.0573fang.com/statics/js/jquery142.js"></script>
<script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&amp;ak=E3d6702fa51f6cb6ef3023b16eff4496"></script>
<script type="text/javascript" src="http://api.map.baidu.com/getscript?v=2.0&amp;ak=E3d6702fa51f6cb6ef3023b16eff4496&amp;services=&amp;t=20170321153029"></script>
<script type="text/javascript" src="http://api.map.baidu.com/library/TextIconOverlay/1.2/src/TextIconOverlay_min.js"></script>
<link rel="stylesheet" type="text/css" href="http://www.0573fang.com/statics/images/map/all.css">
<link type="text/css" rel="stylesheet" href="http://www.0573fang.com/statics/images/map/map_search.css?100927_1">
<link rel="stylesheet" type="text/css" href="http://www.0573fang.com/statics/images/map/header-m.css">
<style>
.map_tip_loading{position: absolute;padding:7px 0 7px 0;width:185px;height:30px;text-align:center;background:#000;ffilter:Alpha(Opacity=70);opacity:.7;color:#fff;line-height:28px;margin:auto;left:0;top:0;z-index:99999;}
.loading_pic{background:url("http://pages.anjukestatic.com/img/ajkmap/2/ajax-loader.gif") no-repeat;width:16px;height:16px;vertical-align:middle;display:inline-block;margin-right:10px;}
#area10 .markbg{height:251px;}
#area10 .mark{height:250px;}
#map_Tips{height:80%;}
#area2_m1{width:100%;}
#contenter_{border-bottom:0;}
#area2_{margin-top:0;}
</style>
...
<link rel="stylesheet" type="text/css" href="http://www.0573fang.com/statics/images/map/header-m.css">
<!--<div id="area1">
  <div style="float:left;height:29px;line-height:29px;font-size:12px;padding-left:10px;" id="memberfirst"><a href="http://www.0573fang.com/index.php?g=Member&amp;a=login">[会员登录]</a> <a href="http://www.0573fang.com/index.php?g=Member&amp;a=register" style="color:#f26858">[免费注册 发布房源]</a> <a href="http://www.0573fang.com/shortcut.php" target="_blank" title="将本站保存到桌面">[设为桌面]</a></div>
  <div id="area1_r" style="float:right;">
    <ul>
      <li class="a1_1"><a href="http://www.0573fang.com/" class="f14">首页</a></li>
	  <li class="a1_1"><a href="http://www.0573fang.com/news/" class="f14">资讯</a></li>
	  <li class="a1_1"><a href="http://www.0573fang.com/newhouse/" class="f14">新楼盘</a></li>
	  <li class="a1_1"><a href="http://www.0573fang.com/second/" class="f14">二手房</a></li>
	  <li class="a1_1"><a href="http://www.0573fang.com/rent/" class="f14">租房</a></li>
	  <li class="a1_1" style="border:0px;"><a href="http://www.0573fang.com/community/" class="f14">小区</a></li>
    </ul>
  </div>
</div>
...
<script type="text/javascript">
//顶部部登录
$.get("http://www.0573fang.com/index.php?g=Member&m=Ajax", {"act":"memberfirst_simple"},
function (data)
{
...
<div id="area2_">
   <!-- <div id="area2_1">
       ...
       <!-- <div id="area2_m11"><a title="嘉论房产网" href="http://www.0573fang.com/"><img src="http://www.0573fang.com/statics/0573ren/images/logosmall.png" border="0"></a></div>
        
        <div id="area2_m13"></div>
        <div id="area2_m14">
            <ul id="nav">-->
                <!--<li menu="mgs">商家地图</li>
                <li menu="mai">二手房地图</li>
                <li menu="zhu">租房地图</li>
                <li menu="xiaoqu">小区地图</li>-->
				<!--<li menu="xin" class="current">租房地图</li>
				<li><a href="http://www.0573fang.com/map/secondhouse/" style="color:#E92C2C;font-size:14px;">二手房地图</a></li>
				<li><a href="http://www.0573fang.com/map/#mode=xin" style="color:#E92C2C;font-size:14px;">新房地图</a></li>
            </ul>
            </div>
        </div>
    </div>-->
    ...
    <div id="area2_3">
        <div id="area2_31"></div>
        <div id="area2_32">找房条件：</div>
    <div id="area2_33"><b>楼盘</b>：
          <input type="text" size="12" id="keyword">
      </div>
      <div id="area2_34">
          <input name="" type="image" src="http://www.0573fang.com/statics/images/map/dt_bu.gif" onclick="searchkw($(&#39;#keyword&#39;).val());">
      </div>
    </div>-->
    <div id="area10" style="height: 612px;">
	<div class="map_tip_loading" style="display: none; left: 496.5px;"><i class="loading_pic"></i><b>房源加载中</b></div>


     <div id="area10_1" style="display:none;">
	  <div class="markbg"></div>
		<div class="mark">
			<table width="100%">
				<tbody><tr>
					<td style="text-align: center; height: 12px; padding-left: 0px;">
						房源显示区域
						<br>
						－－－－－
					</td>
				...
				<tr>
					<td style="text-align: left; height: 2px; padding-left: 0px;">
						<input id="colorChk201" type="checkbox" checked="checked" onclick="listAreaw(this)" value="中心城区">
						<label for="colorChk201"><span>中心城区</span></label>
					</td>
				</tr>
				<tr>
					<td style="text-align: left; height: 2px; padding-left: 0px;">
						<input id="colorChk202" type="checkbox" checked="checked" onclick="listAreaw(this)" value="南湖新区">
						<label for="colorChk202"><span>南湖新区</span></label>
					</td>
				</tr>
				<tr>
					<td style="text-align: left; height: 2px; padding-left: 0px;">
						<input id="colorChk203" type="checkbox" checked="checked" onclick="listAreaw(this)" value="秀洲新区">
						<label for="colorChk203"><span>秀洲新区</span></label>
					</td>
				</tr>
				<tr>
					<td style="text-align: left; height: 2px; padding-left: 0px;">
						<input id="colorChk205" type="checkbox" checked="checked" onclick="listAreaw(this)" value="城西区">
						<label for="colorChk205"><span>城西区</span></label>
					</td>
				</tr>
				<tr>
					<td style="text-align: left; height: 2px; padding-left: 0px;">
						<input id="colorChk206" type="checkbox" checked="checked" onclick="listAreaw(this)" value="城北区">
						<label for="colorChk206"><span>城北区</span></label>
					</td>
				</tr>
				<tr>
					<td style="text-align: left; height: 2px; padding-left: 0px;">
						<input id="colorChk204" type="checkbox" checked="checked" onclick="listAreaw(this)" value="西南区">
						<label for="colorChk204"><span>西南区</span></label>
					</td>
				</tr>
				<tr>
					<td style="text-align: left; height: 2px; padding-left: 0px;">
						<input id="colorChk207" type="checkbox" checked="checked" onclick="listAreaw(this)" value="国际商务区">
						<label for="colorChk207"><span>国际商务区</span></label>
					</td>
				</tr>
				<tr>
					<td style="text-align: left; height: 2px; padding-left: 0px;">
						<input id="colorChk208" type="checkbox" checked="checked" onclick="listAreaw(this)" value="城南区">
						<label for="colorChk208"><span>城南区</span></label>
					</td>
				</tr>
				<tr>
					<td style="text-align: left; height: 2px; padding-left: 0px;">
						<input id="colorChk209" type="checkbox" checked="checked" onclick="listAreaw(this)" value="湘家荡">
						<label for="colorChk209"><span>湘家荡</span></label>
					</td>
				</tr>
				<tr>
					<td style="text-align: center; height: 2px; padding-left: 0px;">
						<input id="colorChk0" type="checkbox" checked="checked" onclick="checkAll();" value="">
						<label for="colorChk0"><span>显示全部</span></label>
					</td>
				</tr>
			</tbody></table>
		</div>
    ...
    <!--zuo ce lan     start     -->
    <div id="map_canvas" style="overflow: hidden; position: relative; z-index: 0; color: rgb(0, 0, 0); text-align: left; width: 1173px; background-color: rgb(243, 241, 236);"><div style="overflow: visible; position: absolute; z-index: 0; left: 0px; top: 0px; cursor: url(&quot;http://api0.map.bdimg.com/images/openhand.cur&quot;) 8 8, default;"><div class="BMap_mask" style="position: absolute; left: 0px; top: 0px; z-index: 9; overflow: hidden; -webkit-user-select: none; width: 1173px; height: 612px;"></div><div style="position: absolute; height: 0px; width: 0px; left: 0px; top: 0px; z-index: 200;"><div style="position: absolute; height: 0px; width: 0px; left: 0px; top: 0px; z-index: 800;"></div><div style="position: absolute; height: 0px; width: 0px; left: 0px; top: 0px; z-index: 700;"></div><div style="position: absolute; height: 0px; width: 0px; left: 0px; top: 0px; z-index: 600;"></div><div style="position: absolute; height: 0px; width: 0px; left: 0px; top: 0px; z-index: 500;"><div class="areas" style="position: absolute; z-index: 0; cursor: pointer; width: 74px; height: 40px; padding: 20px 0px 14px; color: white; font-size: 14px; text-align: center; -webkit-user-select: none; left: -839520px; top: 223979px; background: url(&quot;345_files/mark32-1.png&quot;) -92px -92px no-repeat scroll rgba(0, 0, 0, 0);"><span style="display: block; font-weight: 700;"></span><span style="display: block; font-size: 12px; height: 22px; line-height: 22px;">77套</span></div><div class="areas" style="position: absolute; z-index: -6153706; cursor: pointer; width: 74px; height: 40px; padding: 20px 0px 14px; color: white; font-size: 14px; text-align: center; -webkit-user-select: none; left: 639px; top: 187px; background: url(&quot;345_files/mark32-1.png&quot;) -92px -92px no-repeat scroll rgba(0, 0, 0, 0);"><span style="display: block; font-weight: 700;">中心城区</span><span style="display: block; font-size: 12px; height: 22px; line-height: 22px;">1452套</span></div><div class="areas" style="position: absolute; z-index: -6150404; cursor: pointer; width: 74px; height: 40px; padding: 20px 0px 14px; color: white; font-size: 14px; text-align: center; -webkit-user-select: none; left: 806px; top: 320px; background: url(&quot;345_files/mark32-1.png&quot;) -92px -92px no-repeat scroll rgba(0, 0, 0, 0);"><span style="display: block; font-weight: 700;">南湖新区</span><span style="display: block; font-size: 12px; height: 22px; line-height: 22px;">1953套</span></div><div class="areas" style="position: absolute; z-index: -6157738; cursor: pointer; width: 74px; height: 40px; padding: 20px 0px 14px; color: white; font-size: 14px; text-align: center; -webkit-user-select: none; left: 245px; top: 25px; background: url(&quot;345_files/mark32-1.png&quot;) -92px -92px no-repeat scroll rgba(0, 0, 0, 0);"><span style="display: block; font-weight: 700;">秀洲新区</span><span style="display: block; font-size: 12px; height: 22px; line-height: 22px;">560套</span></div><div class="areas" style="position: absolute; z-index: -6150664; cursor: pointer; width: 74px; height: 40px; padding: 20px 0px 14px; color: white; font-size: 14px; text-align: center; -webkit-user-select: none; left: 323px; top: 310px; background: url(&quot;345_files/mark32-1.png&quot;) -92px -92px no-repeat scroll rgba(0, 0, 0, 0);"><span style="display: block; font-weight: 700;">西南区</span><span style="display: block; font-size: 12px; height: 22px; line-height: 22px;">117套</span></div><div class="areas" style="position: absolute; z-index: -6154338; cursor: pointer; width: 74px; height: 40px; padding: 20px 0px 14px; color: white; font-size: 14px; text-align: center; -webkit-user-select: none; left: 363px; top: 161px; background: url(&quot;345_files/mark32-1.png&quot;) -92px -92px no-repeat scroll rgba(0, 0, 0, 0);"><span style="display: block; font-weight: 700;">城西区</span><span style="display: block; font-size: 12px; height: 22px; line-height: 22px;">376套</span></div><div class="areas" style="position: absolute; z-index: -6157118; cursor: pointer; width: 74px; height: 40px; padding: 20px 0px 14px; color: white; font-size: 14px; text-align: center; -webkit-user-select: none; left: 643px; top: 49px; background: url(&quot;345_files/mark32-1.png&quot;) -92px -92px no-repeat scroll rgba(0, 0, 0, 0);"><span style="display: block; font-weight: 700;">城北区</span><span style="display: block; font-size: 12px; height: 22px; line-height: 22px;">107套</span></div><div class="areas" style="position: absolute; z-index: -6147088; cursor: pointer; width: 74px; height: 40px; padding: 20px 0px 14px; color: white; font-size: 14px; text-align: center; -webkit-user-select: none; left: 629px; top: 454px; background: url(&quot;345_files/mark32-1.png&quot;) -92px -92px no-repeat scroll rgba(0, 0, 0, 0);"><span style="display: block; font-weight: 700;">国际商务区</span><span style="display: block; font-size: 12px; height: 22px; line-height: 22px;">199套</span></div><div class="areas" style="position: absolute; z-index: -6149920; cursor: pointer; width: 74px; height: 40px; padding: 20px 0px 14px; color: white; font-size: 14px; text-align: center; -webkit-user-select: none; left: 481px; top: 339px; background: url(&quot;345_files/mark32-1.png&quot;) -92px -92px no-repeat scroll rgba(0, 0, 0, 0);"><span style="display: block; font-weight: 700;">城南区</span><span style="display: block; font-size: 12px; height: 22px; line-height: 22px;">147套</span></div><div class="areas" style="position: absolute; z-index: -6161362; cursor: pointer; width: 74px; height: 40px; padding: 20px 0px 14px; color: white; font-size: 14px; text-align: center; -webkit-user-select: none; left: 1076px; top: -121px; background: url(&quot;345_files/mark32-1.png&quot;) -92px -92px no-repeat scroll rgba(0, 0, 0, 0);"><span style="display: block; font-weight: 700;">湘家荡</span><span style="display: block; font-size: 12px; height: 22px; line-height: 22px;">9套</span></div><div class="areas" style="position: absolute; z-index: 0; cursor: pointer; width: 74px; height: 40px; padding: 20px 0px 14px; color: white; font-size: 14px; text-align: center; -webkit-user-select: none; left: -839520px; top: 223979px; background: url(&quot;345_files/mark32-1.png&quot;) -92px -92px no-repeat scroll rgba(0, 0, 0, 0);"><span style="display: block; font-weight: 700;"></span><span style="display: block; font-size: 12px; height: 22px; line-height: 22px;">1套</span></div><div class="areas" style="position: absolute; z-index: 0; cursor: pointer; width: 74px; height: 40px; padding: 20px 0px 14px; color: white; font-size: 14px; text-align: center; -webkit-user-select: none; left: -839520px; top: 223979px; background: url(&quot;345_files/mark32-1.png&quot;) -92px -92px no-repeat scroll rgba(0, 0, 0, 0);"><span style="display: block; font-weight: 700;"></span><span style="display: block; font-size: 12px; height: 22px; line-height: 22px;">32套</span></div><div class="areas" style="position: absolute; z-index: 0; cursor: pointer; width: 74px; height: 40px; padding: 20px 0px 14px; color: white; font-size: 14px; text-align: center; -webkit-user-select: none; left: -839520px; top: 223979px; background: url(&quot;345_files/mark32-1.png&quot;) -92px -92px no-repeat scroll rgba(0, 0, 0, 0);"><span style="display: block; font-weight: 700;"></span><span style="display: block; font-size: 12px; height: 22px; line-height: 22px;">69套</span></div><label class="BMapLabel" unselectable="on" style="position: absolute; display: none; cursor: inherit; border: 1px solid rgb(190, 190, 190); padding: 1px; white-space: nowrap; font-style: normal; font-variant: normal; font-weight: normal; font-stretch: normal; font-size: 12px; line-height: normal; font-family: arial, sans-serif; z-index: -20000; color: rgb(190, 190, 190); background-color: rgb(190, 190, 190);">shadow</label></div><div style="position: absolute; height: 0px; width: 0px; left: 0px; top: 0px; z-index: 400;"></div><div style="position: absolute; height: 0px; width: 0px; left: 0px; top: 0px; z-index: 300;"></div><div style="position: absolute; height: 0px; width: 0px; left: 0px; top: 0px; z-index: 201;"></div><div style="position: absolute; height: 0px; width: 0px; left: 0px; top: 0px; z-index: 200;"></div></div><div style="position: absolute; overflow: visible; top: 0px; left: 0px; z-index: 1;"><div style="position: absolute; overflow: visible; z-index: -100; left: 586px; top: 306px; display: block; transform: translate3d(0px, 0px, 0px);"><img src="http://online0.map.bdimg.com/tile/?qt=tile&amp;x=3282&amp;y=873&amp;z=14&amp;styles=pl&amp;scaler=1&amp;udt=20170301" style="position: absolute; border: none; width: 256px; height: 256px; left: 86px; top: -56px; max-width: none; opacity: 1;"><img src="http://online4.map.bdimg.com/tile/?qt=tile&amp;x=3281&amp;y=873&amp;z=14&amp;styles=pl&amp;scaler=1&amp;udt=20170301" style="position: absolute; border: none; width: 256px; height: 256px; left: -170px; top: -56px; max-width: none; opacity: 1;"><img src="http://online1.map.bdimg.com/tile/?qt=tile&amp;x=3283&amp;y=873&amp;z=14&amp;styles=pl&amp;scaler=1&amp;udt=20170301" style="position: absolute; border: none; width: 256px; height: 256px; left: 342px; top: -56px; max-width: none; opacity: 1;"><img src="http://online1.map.bdimg.com/tile/?qt=tile&amp;x=3282&amp;y=874&amp;z=14&amp;styles=pl&amp;scaler=1&amp;udt=20170301" style="position: absolute; border: none; width: 256px; height: 256px; left: 86px; top: -312px; max-width: none; opacity: 1;"><img src="http://online3.map.bdimg.com/tile/?qt=tile&amp;x=3280&amp;y=873&amp;z=14&amp;styles=pl&amp;scaler=1&amp;udt=20170301" style="position: absolute; border: none; width: 256px; height: 256px; left: -426px; top: -56px; max-width: none; opacity: 1;"><img src="http://online0.map.bdimg.com/tile/?qt=tile&amp;x=3281&amp;y=874&amp;z=14&amp;styles=pl&amp;scaler=1&amp;udt=20170301" style="position: absolute; border: none; width: 256px; height: 256px; left: -170px; top: -312px; max-width: none; opacity: 1;"><img src="http://online2.map.bdimg.com/tile/?qt=tile&amp;x=3283&amp;y=874&amp;z=14&amp;styles=pl&amp;scaler=1&amp;udt=20170301" style="position: absolute; border: none; width: 256px; height: 256px; left: 342px; top: -312px; max-width: none; opacity: 1;"><img src="http://online2.map.bdimg.com/tile/?qt=tile&amp;x=3279&amp;y=873&amp;z=14&amp;styles=pl&amp;scaler=1&amp;udt=20170301" style="position: absolute; border: none; width: 256px; height: 256px; left: -682px; top: -56px; max-width: none; opacity: 1;"><img src="http://online4.map.bdimg.com/tile/?qt=tile&amp;x=3280&amp;y=874&amp;z=14&amp;styles=pl&amp;scaler=1&amp;udt=20170301" style="position: absolute; border: none; width: 256px; height: 256px; left: -426px; top: -312px; max-width: none; opacity: 1;"><img src="http://online3.map.bdimg.com/tile/?qt=tile&amp;x=3279&amp;y=874&amp;z=14&amp;styles=pl&amp;scaler=1&amp;udt=20170301" style="position: absolute; border: none; width: 256px; height: 256px; left: -682px; top: -312px; max-width: none; opacity: 1;"><img src="http://online3.map.bdimg.com/tile/?qt=tile&amp;x=3281&amp;y=872&amp;z=14&amp;styles=pl&amp;scaler=1&amp;udt=20170301" style="position: absolute; border: none; width: 256px; height: 256px; left: -170px; top: 200px; max-width: none; opacity: 1;"><img src="http://online2.map.bdimg.com/tile/?qt=tile&amp;x=3280&amp;y=872&amp;z=14&amp;styles=pl&amp;scaler=1&amp;udt=20170301" style="position: absolute; border: none; width: 256px; height: 256px; left: -426px; top: 200px; max-width: none; opacity: 1;"><img src="http://online4.map.bdimg.com/tile/?qt=tile&amp;x=3282&amp;y=872&amp;z=14&amp;styles=pl&amp;scaler=1&amp;udt=20170301" style="position: absolute; border: none; width: 256px; height: 256px; left: 86px; top: 200px; max-width: none; opacity: 1;"><img src="http://online1.map.bdimg.com/tile/?qt=tile&amp;x=3279&amp;y=872&amp;z=14&amp;styles=pl&amp;scaler=1&amp;udt=20170301" style="position: absolute; border: none; width: 256px; height: 256px; left: -682px; top: 200px; max-width: none; opacity: 1;"><img src="http://online0.map.bdimg.com/tile/?qt=tile&amp;x=3283&amp;y=872&amp;z=14&amp;styles=pl&amp;scaler=1&amp;udt=20170301" style="position: absolute; border: none; width: 256px; height: 256px; left: 342px; top: 200px; max-width: none; opacity: 1;"></div></div><div style="position: absolute; overflow: visible; top: 0px; left: 0px; z-index: 2; display: none;"><div style="position: absolute; overflow: visible; top: 0px; left: 0px; z-index: 0; display: none;"></div><div style="position: absolute; overflow: visible; top: 0px; left: 0px; z-index: 10; display: none;"></div></div><div style="position: absolute; overflow: visible; top: 0px; left: 0px; z-index: 3;"></div></div><div class="pano_close" title="退出全景" style="z-index: 1201; display: none;"></div><a class="pano_pc_indoor_exit" title="退出室内景" style="z-index: 1201; display: none;"><span style="float:right;margin-right:12px;">出口</span></a><div class=" anchorBL" style="height: 32px; position: absolute; z-index: 30; bottom: 20px; right: auto; top: auto; left: 1px;"><a title="到百度地图查看此区域" target="_blank" href="http://map.baidu.com/?sr=1" style="outline: none;"><img style="border:none;width:77px;height:32px" src="http://api0.map.bdimg.com/images/copyright_logo.png"></a></div><div id="zoomer" style="position:absolute;z-index:0;top:0px;left:0px;overflow:hidden;visibility:hidden;cursor:url(http://api0.map.bdimg.com/images/openhand.cur) 8 8,default"><div class="BMap_zoomer" style="top:0;left:0;"></div><div class="BMap_zoomer" style="top:0;right:0;"></div><div class="BMap_zoomer" style="bottom:0;left:0;"></div><div class="BMap_zoomer" style="bottom:0;right:0;"></div></div><div unselectable="on" class=" BMap_cpyCtrl BMap_noprint anchorBL" style="cursor: default; white-space: nowrap; color: black; font-style: normal; font-variant: normal; font-weight: normal; font-stretch: normal; font-size: 11px; line-height: 15px; font-family: arial, sans-serif; bottom: 2px; right: auto; top: auto; left: 2px; position: absolute; z-index: 10; background: none;"><span _cid="1" style="display: inline;"><span style="background: rgba(255, 255, 255, 0.701961);padding: 0px 1px;line-height: 16px;display: inline;height: 16px;">©&nbsp;2017 Baidu - GS(2015)2650号&nbsp;- Data © 长地万方</span></span></div></div>
    <!--zuo ce lan     end     -->
    <!--zhong jian lan     start     --
    <div id="area10_2" class="toggle" style=""></div>
    <!--zhong jian lan     end     -->
    ...
    <div id="area10_3">
        <div id="area10_4">
        <div id="area10_5">搜索结果<input type="text" id="areaStr" style="display:none;"><input type="text" id="listact" value="loupan" style="display:none;"></div>
        <div id="area10_6"></div>
        </div>
        <div class="area10_7">
			<span id="mapCountTip" style="font-size: 12px;">&nbsp;共找到682个租房所在楼盘!</span>
        </div>
        <div id="map_Tips_Page" style="height: 20px;">
			<table border="0" cellspacing="0" cellpadding="0" align="left">
				<tbody><tr>
				<td align="left" width="46" id="map_Tips_Page_Pre" onclick="preData();" style="cursor:pointer;">上一页</td>
				<td align="center" width="60" id="map_Tips_Page_Mid">第1/46页</td>
				<td align="left" width="46" id="map_Tips_Page_Next" onclick="nextData();" style="cursor:pointer;">下一页</td>
				</tr>
			</tbody></table>
        </div>
        <div id="map_Tips"><div class="area10_11" onclick="mp.centerAndZoom(new BMap.Point(NaN,NaN), 15);" onmouseover="$(&#39;.loupan21736&#39;).css(&#39;background-color&#39;,&#39;#2b9225&#39;);this.style.background=&#39;white&#39;" onmouseout="$(&#39;.loupan21736&#39;).css(&#39;background-color&#39;,&#39;#EE5D5B&#39;);this.style.background=&#39;#FAFAFA&#39;"><span class="hei33 bold">虹桥新村</span>【1套】&nbsp;[<a href="javascript:;" onclick="listFang(21736);" class="lan">详情</a>]<br> 所在区域：南湖新区<br>均价：1600元/m²<br>建设年份：null</div><div class="area10_11" onclick="mp.centerAndZoom(new BMap.Point(NaN,NaN), 15);" onmouseover="$(&#39;.loupan21735&#39;).css(&#39;background-color&#39;,&#39;#2b9225&#39;);this.style.background=&#39;white&#39;" onmouseout="$(&#39;.loupan21735&#39;).css(&#39;background-color&#39;,&#39;#EE5D5B&#39;);this.style.background=&#39;#FAFAFA&#39;"><span class="hei33 bold">中港城新世纪单身公寓</span>【1套】&nbsp;[<a href="javascript:;" onclick="listFang(21735);" class="lan">详情</a>]<br> 所在区域：南湖新区<br>均价：1300元/m²<br>建设年份：null</div><div class="area10_11" onclick="mp.centerAndZoom(new BMap.Point(NaN,NaN), 15);" onmouseover="$(&#39;.loupan21652&#39;).css(&#39;background-color&#39;,&#39;#2b9225&#39;);this.style.background=&#39;white&#39;" onmouseout="$(&#39;.loupan21652&#39;).css(&#39;background-color&#39;,&#39;#EE5D5B&#39;);this.style.background=&#39;#FAFAFA&#39;"><span class="hei33 bold">同方2008燕雨林苑</span>【1套】&nbsp;[<a href="javascript:;" onclick="listFang(21652);" class="lan">详情</a>]<br> 所在区域：南湖新区<br>均价：1200元/m²<br>建设年份：null</div><div class="area10_11" onclick="mp.centerAndZoom(new BMap.Point(NaN,NaN), 15);" onmouseover="$(&#39;.loupan21650&#39;).css(&#39;background-color&#39;,&#39;#2b9225&#39;);this.style.background=&#39;white&#39;" onmouseout="$(&#39;.loupan21650&#39;).css(&#39;background-color&#39;,&#39;#EE5D5B&#39;);this.style.background=&#39;#FAFAFA&#39;"><span class="hei33 bold">塘汇路</span>【2套】&nbsp;[<a href="javascript:;" onclick="listFang(21650);" class="lan">详情</a>]<br> 所在区域：南湖新区<br>均价：45000元/m²<br>建设年份：null</div><div class="area10_11" onclick="mp.centerAndZoom(new BMap.Point(NaN,NaN), 15);" onmouseover="$(&#39;.loupan21649&#39;).css(&#39;background-color&#39;,&#39;#2b9225&#39;);this.style.background=&#39;white&#39;" onmouseout="$(&#39;.loupan21649&#39;).css(&#39;background-color&#39;,&#39;#EE5D5B&#39;);this.style.background=&#39;#FAFAFA&#39;"><span class="hei33 bold">嘉兴国际中港城新世纪</span>【1套】&nbsp;[<a href="javascript:;" onclick="listFang(21649);" class="lan">详情</a>]<br> 所在区域：南湖新区<br>均价：1400元/m²<br>建设年份：null</div><div class="area10_11" onclick="mp.centerAndZoom(new BMap.Point(NaN,NaN), 15);" onmouseover="$(&#39;.loupan21645&#39;).css(&#39;background-color&#39;,&#39;#2b9225&#39;);this.style.background=&#39;white&#39;" onmouseout="$(&#39;.loupan21645&#39;).css(&#39;background-color&#39;,&#39;#EE5D5B&#39;);this.style.background=&#39;#FAFAFA&#39;"><span class="hei33 bold">探花苑8-506</span>【1套】&nbsp;[<a href="javascript:;" onclick="listFang(21645);" class="lan">详情</a>]<br> 所在区域：南湖新区<br>均价：1800元/m²<br>建设年份：null</div><div class="area10_11" onclick="mp.centerAndZoom(new BMap.Point(NaN,NaN), 15);" onmouseover="$(&#39;.loupan21631&#39;).css(&#39;background-color&#39;,&#39;#2b9225&#39;);this.style.background=&#39;white&#39;" onmouseout="$(&#39;.loupan21631&#39;).css(&#39;background-color&#39;,&#39;#EE5D5B&#39;);this.style.background=&#39;#FAFAFA&#39;"><span class="hei33 bold">台升怡府</span>【1套】&nbsp;[<a href="javascript:;" onclick="listFang(21631);" class="lan">详情</a>]<br> 所在区域：南湖新区<br>均价：2000元/m²<br>建设年份：null</div><div class="area10_11" onclick="mp.centerAndZoom(new BMap.Point(NaN,NaN), 15);" onmouseover="$(&#39;.loupan21615&#39;).css(&#39;background-color&#39;,&#39;#2b9225&#39;);this.style.background=&#39;white&#39;" onmouseout="$(&#39;.loupan21615&#39;).css(&#39;background-color&#39;,&#39;#EE5D5B&#39;);this.style.background=&#39;#FAFAFA&#39;"><span class="hei33 bold">宝格丽公馆商铺</span>【1套】&nbsp;[<a href="javascript:;" onclick="listFang(21615);" class="lan">详情</a>]<br> 所在区域：南湖新区<br>均价：384300元/m²<br>建设年份：null</div><div class="area10_11" onclick="mp.centerAndZoom(new BMap.Point(NaN,NaN), 15);" onmouseover="$(&#39;.loupan21611&#39;).css(&#39;background-color&#39;,&#39;#2b9225&#39;);this.style.background=&#39;white&#39;" onmouseout="$(&#39;.loupan21611&#39;).css(&#39;background-color&#39;,&#39;#EE5D5B&#39;);this.style.background=&#39;#FAFAFA&#39;"><span class="hei33 bold">景湖花园东区</span>【1套】&nbsp;[<a href="javascript:;" onclick="listFang(21611);" class="lan">详情</a>]<br> 所在区域：南湖新区<br>均价：2200元/m²<br>建设年份：null</div><div class="area10_11" onclick="mp.centerAndZoom(new BMap.Point(NaN,NaN), 15);" onmouseover="$(&#39;.loupan21610&#39;).css(&#39;background-color&#39;,&#39;#2b9225&#39;);this.style.background=&#39;white&#39;" onmouseout="$(&#39;.loupan21610&#39;).css(&#39;background-color&#39;,&#39;#EE5D5B&#39;);this.style.background=&#39;#FAFAFA&#39;"><span class="hei33 bold">世贸尚景蓝湾</span>【1套】&nbsp;[<a href="javascript:;" onclick="listFang(21610);" class="lan">详情</a>]<br> 所在区域：南湖新区<br>均价：2000元/m²<br>建设年份：null</div><div class="area10_11" onclick="mp.centerAndZoom(new BMap.Point(NaN,NaN), 15);" onmouseover="$(&#39;.loupan21609&#39;).css(&#39;background-color&#39;,&#39;#2b9225&#39;);this.style.background=&#39;white&#39;" onmouseout="$(&#39;.loupan21609&#39;).css(&#39;background-color&#39;,&#39;#EE5D5B&#39;);this.style.background=&#39;#FAFAFA&#39;"><span class="hei33 bold">浙江嘉兴文贤路文贤苑</span>【1套】&nbsp;[<a href="javascript:;" onclick="listFang(21609);" class="lan">详情</a>]<br> 所在区域：南湖新区<br>均价：1000元/m²<br>建设年份：null</div><div class="area10_11" onclick="mp.centerAndZoom(new BMap.Point(NaN,NaN), 15);" onmouseover="$(&#39;.loupan21605&#39;).css(&#39;background-color&#39;,&#39;#2b9225&#39;);this.style.background=&#39;white&#39;" onmouseout="$(&#39;.loupan21605&#39;).css(&#39;background-color&#39;,&#39;#EE5D5B&#39;);this.style.background=&#39;#FAFAFA&#39;"><span class="hei33 bold">洪仁路</span>【1套】&nbsp;[<a href="javascript:;" onclick="listFang(21605);" class="lan">详情</a>]<br> 所在区域：秀洲新区<br>均价：800元/m²<br>建设年份：null</div><div class="area10_11" onclick="mp.centerAndZoom(new BMap.Point(NaN,NaN), 15);" onmouseover="$(&#39;.loupan21596&#39;).css(&#39;background-color&#39;,&#39;#2b9225&#39;);this.style.background=&#39;white&#39;" onmouseout="$(&#39;.loupan21596&#39;).css(&#39;background-color&#39;,&#39;#EE5D5B&#39;);this.style.background=&#39;#FAFAFA&#39;"><span class="hei33 bold">秀洲江南摩尔</span>【1套】&nbsp;[<a href="javascript:;" onclick="listFang(21596);" class="lan">详情</a>]<br> 所在区域：秀洲新区<br>均价：1400元/m²<br>建设年份：null</div><div class="area10_11" onclick="mp.centerAndZoom(new BMap.Point(NaN,NaN), 15);" onmouseover="$(&#39;.loupan21595&#39;).css(&#39;background-color&#39;,&#39;#2b9225&#39;);this.style.background=&#39;white&#39;" onmouseout="$(&#39;.loupan21595&#39;).css(&#39;background-color&#39;,&#39;#EE5D5B&#39;);this.style.background=&#39;#FAFAFA&#39;"><span class="hei33 bold">越秀南路-文秀里</span>【1套】&nbsp;[<a href="javascript:;" onclick="listFang(21595);" class="lan">详情</a>]<br> 所在区域：南湖新区<br>均价：1200元/m²<br>建设年份：null</div><div class="area10_11" onclick="mp.centerAndZoom(new BMap.Point(NaN,NaN), 15);" onmouseover="$(&#39;.loupan21591&#39;).css(&#39;background-color&#39;,&#39;#2b9225&#39;);this.style.background=&#39;white&#39;" onmouseout="$(&#39;.loupan21591&#39;).css(&#39;background-color&#39;,&#39;#EE5D5B&#39;);this.style.background=&#39;#FAFAFA&#39;"><span class="hei33 bold">公交宿舍</span>【1套】&nbsp;[<a href="javascript:;" onclick="listFang(21591);" class="lan">详情</a>]<br> 所在区域：南湖新区<br>均价：1500元/m²<br>建设年份：null</div></div>
        <div class="ie6bug">1234567890</div>
    </div>
    <!--you ce lan     end     -->
...
/*	_width = _width - 250;
	_height = _height - 160;*/
	$("#map_canvas").width(_width);
	$("#area10").height(_height);
	$('#area10_2').show();
	$('#area10_3').show();
	$('.map_tip_loading').css('left', _width/2-90);//加载提示框位置
}
...
<script type="text/javascript">
	...
	area[0] = '121.400993,31.254593|普陀|77套';area[1] = '121.533798,31.233846|浦东|1452套';area[2] = '121.451585,31.233846|静安|1953套';area[3] = '121.418528,31.222729|长宁|560套';area[4] = '121.478894,31.397475|宝山|117套';area[5] = '121.393231,31.123858|闵行|376套';area[6] = '121.23513,31.03528|松江|107套';area[7] = '121.441812,31.19728|徐汇|199套';area[8] = '121.493842,31.235081|黄浦|147套';area[9] = '121.532648,31.265953|杨浦|9套';area[10] = '121.508502,31.272373|虹口|1套';area[11] = '121.139693,31.158413|青浦|32套';area[12] = '121.348388,30.750366|金山|69套';area[13] = '121.480043,30.92376|奉贤|69套';	xiaoqu[28] = new Array(6,'铂悦滨江','1850','121.561477,31.248535','206');	var qus = new Array();qus['中心城区'] = 201;qus['南湖新区'] = 202;qus['秀洲新区'] = 203;qus['城西区'] = 205;qus['城北区'] = 206;qus['西南区'] = 204;qus['国际商务区'] = 207;qus['城南区'] = 208;qus['湘家荡'] = 209;	var qus2 = new Array();qus2[201] = '中心城区';qus2[202] = '南湖新区';qus2[203] = '秀洲新区';qus2[205] = '城西区';qus2[206] = '城北区';qus2[204] = '西南区';qus2[207] = '国际商务区';qus2[208] = '城南区';qus2[209] = '湘家荡';
	// 百度地图API功能
	var mp = new BMap.Map("map_canvas");
	mp.centerAndZoom(new BMap.Point(121.481207,31.236573), 14);//定义中心点
    ...
    ComplexCustomOverlay.prototype.initialize = function(map){
      ...
      div.style.background = "url(345_files/mark32-1.png) no-repeat scroll -92px -92px rgba(0, 0, 0, 0)";
      ...
      div.onmouseover = function(){
		 div.style.background = "url(345_files/mark32-1.png) no-repeat scroll 0px -92px rgba(0, 0, 0, 0)";
      }
	  ...
	  var currarea = this._text;
	  //点击区块，进入楼盘(地图放大及定位)
	  div.onclick = function() {
		 var _str = $('#areaStr').val();
		 var _m = _str.split(',');
		 var _t = true;
		 ...
		 if(_t == true) {
			$('#areaStr').attr('value', _str+(_str=='' ? '' : ',')+currarea);
		 }
		 
		 loadData();

		 var m = area[index].split('|');
		 var s = m[0].split(',');
		 s[0] = parseFloat(s[0]);
		 s[1] = parseFloat(s[1]);
		 mp.centerAndZoom(new BMap.Point(s[0],s[1]), 15);
	  }
	...
	for(i=0;i<area.length;i++) {
		...
		s[0] = parseFloat(s[0]);
		s[1] = parseFloat(s[1]);
		var myCompOverlay = new ComplexCustomOverlay(new BMap.Point(s[0],s[1]), m[1], m[2], i);
		mp.addOverlay(myCompOverlay);
	}
	
	//楼盘样式
    function ComplexCustomOverlay2(point, text, mouseoverText, id, dq){
      this._point = point;
      this._text = text;
      this._overText = mouseoverText;
	  this._id = id;
    ...
    ComplexCustomOverlay2.prototype.initialize = function(map){
      ...
      div.style.position = "absolute";
      div.style.zIndex = BMap.Overlay.getZIndex(this._point.lat);
      div.style.backgroundColor = "#ff0000";//楼盘背景色
	  ...
	  if(this._dq > 0) {
		div.className = "loupan listlp list"+this._dq+" loupan"+this._id;
	  } else {
		div.className = "loupan loupan"+this._id;
	  }
	  /**/
	  if(this._dq == '湘家荡度假区') {
		div.className = "loupan xjd loupan"+this._id;
	  } else if(this._dq == '城北区') {
		div.className = "loupan cb loupan"+this._id;
	  } else if(this._dq == '城西区') {
		div.className = "loupan cx loupan"+this._id;
	  } else if(this._dq == '秀洲新区') {
		div.className = "loupan xz loupan"+this._id;
	  } else if(this._dq == '西南区') {
		div.className = "loupan xn loupan"+this._id;
	  } else if(this._dq == '南湖区') {
		div.className = "loupan nh loupan"+this._id;
	  } else if(this._dq == '国际商务区') {
		div.className = "loupan gjsm loupan"+this._id;
	  } else if(this._dq == '城南区') {
		div.className = "loupan cn loupan"+this._id;
	  } else {
		div.className = "loupan loupan"+this._id;
	  }
      ...
      arrow.style.background = "url(/statics/images/map/label.png) no-repeat";
      ...
      div.onmouseover = function(){
        this.style.backgroundColor = "#d90000";//楼盘hover
        this.style.borderColor = "#0b3e08";
        this.getElementsByTagName("span")[0].innerHTML = that._overText;
        arrow.style.backgroundPosition = "0px -20px";
      }
	  
      div.onmouseout = function(){
        this.style.backgroundColor = "#ff0000";//楼盘mouseout
	...
	mp.addEventListener("zoomend",function(){
		if(mp.getZoom() == 14) {
			...
			$('.loupan').hide();
			$('#area10_1').hide();
		} else if(mp.getZoom() >14) {
			$('.areas').hide();
			$('.loupan').show();
			$('#area10_1').show();

			for(var obj in xiaoqu) {
				var point = xiaoqu[obj][3];
				var ms = point.split(',');
				ms[0] = parseFloat(ms[0]);
				ms[1] = parseFloat(ms[1]);
				var myCompOverlay2 = new ComplexCustomOverlay2(new BMap.Point(ms[0],ms[1]), xiaoqu[obj][1]+"("+xiaoqu[obj][0]+"套)", xiaoqu[obj][1]+'('+xiaoqu[obj][2]+'元/平)', obj, xiaoqu[obj][4]);
	...
	function listAreaw(obj) {
		var p = 0,str = '';
		for(var i=0;i<$("table :checkbox").length;i++) {
			if($("table :checkbox").eq(i).attr('checked')===true && $("table :checkbox").eq(i).attr('value')!="") {
				p++;
				str = str+(str=='' ? '' : ',')+$("table :checkbox").eq(i).attr('value');
			}
		}

		if(($("table :checkbox").length-1) == p) {
			str = '';
			$('#colorChk0').attr('checked', true);
		}
	...
	function proArea(list) {
		...
		if(_str == '') {
			...
			for(var i=0;i<ss.length;i++) {
				$('.list'+qus[ss[i]]).show();
				$('#colorChk'+qus[ss[i]]).attr('checked', true);
				/**/
				if(ss[i] == '湘家荡度假区') {
					$('.xjd').show();
					$('#colorChk1').attr('checked', true);
				} else if(ss[i] == '城北区') {
					$('.cb').show();
					$('#colorChk2').attr('checked', true);
				} else if(ss[i] == '城西区') {
					$('.cx').show();
					$('#colorChk3').attr('checked', true);
				} else if(ss[i] == '秀洲新区') {
					$('.xz').show();
					$('#colorChk4').attr('checked', true);
				} else if(ss[i] == '西南区') {
					$('.xn').show();
					$('#colorChk5').attr('checked', true);
				} else if(ss[i] == '南湖区') {
					$('.nh').show();
					$('#colorChk6').attr('checked', true);
				} else if(ss[i] == '国际商务区') {
					$('.gjsm').show();
					$('#colorChk8').attr('checked', true);
				} else if(ss[i] == '城南区') {
					$('.cn').show();
					$('#colorChk7').attr('checked', true);
				}
	...
	function loadData() {
		$('#listact').val('loupan');
		var district = $('#areaStr').val();
		if(district != '') {
			var _tmp,_str = '';
			_tem = district.split(',');
			for(i=0;i<_tem.length;i++) {
				_str = (_str ? _str+',' : _str) + (qus[_tem[i]]).toString();
				
			}
			district = _str;
		}
		$.post('/api.php?m=Mapajax&action=map&a=getarearendhouse', {district:district,page:page}, function(datas){
			page = datas.page
			$('#mapCountTip').html('&nbsp;共找到'+datas.cts+'个租房所在楼盘!');
			$('#map_Tips_Page_Mid').html('第'+page+'/'+datas.pagects+'页');
			var str = '';
			var data = datas.data;
			for(var obj in data) {
				var s;
				if(data[obj]['point'] != null) {
					s = data[obj]['point'].split(',');
					s[0] = parseFloat(s[0]);
					s[1] = parseFloat(s[1]);
					str = str + '<div class="area10_11" onclick="mp.centerAndZoom(new BMap.Point('+s[0]+','+s[1]+'), 15);" onmouseover="$(\'.loupan'+data[obj]['village_id']+'\').css(\'background-color\',\'#2b9225\');this.style.background=\'white\'" onmouseout="$(\'.loupan'+data[obj]['village_id']+'\').css(\'background-color\',\'#EE5D5B\');this.style.background=\'#FAFAFA\'" ><span class="hei33 bold">'+data[obj]['village']+'</span>【'+data[obj]['cts']+'套】&nbsp;[<a href="javascript:;" onclick="listFang('+data[obj]['village_id']+');" class="lan">详情</a>]<br> 所在区域：'+qus2[data[obj]['district']]+'<br>均价：'+data[obj]['price_per']+'元/m²<br>建设年份：'+data[obj]['buildat']+'</div>';
				} else {
					str = str + '<div class="area10_11" onmouseover="$(\'.loupan'+data[obj]['village_id']+'\').css(\'background-color\',\'#2b9225\');this.style.background=\'white\'" onmouseout="$(\'.loupan'+data[obj]['village_id']+'\').css(\'background-color\',\'#EE5D5B\');this.style.background=\'#FAFAFA\'" ><span class="hei33 bold">'+data[obj]['village']+'</span>【'+data[obj]['cts']+'套】&nbsp;[<a href="javascript:;" onclick="listFang('+data[obj]['village_id']+');" class="lan">详情</a>]<br> 所在区域：'+qus2[data[obj]['district']]+'<br>均价：'+data[obj]['price_per']+'元/m²<br>建设年份：'+data[obj]['buildat']+'</div>';
				}
			}
			$('#map_Tips').html(str);
		}, 'json');
	...
	function listFang(id) {
		$('#listact').val('fang');
		curr_id = id;
		
		$.post('/api.php?m=Mapajax&action=map&a=gethouserent',{id:id,page:cpage},function(data){
			var _cts = data.data.length;
			cpage = data.page;
			if(_cts > 0) {
				$('#mapCountTip').html('【'+data.name+'】共有'+data.cts+'个房源!&nbsp;<a href="javascript:loadData();"><span color="#ff0000">返回楼盘</span></a>');
				$('#map_Tips_Page_Mid').html('第'+cpage+'/'+data.pagects+'页');
				var str = '';
				for(var i=0;i<_cts;i++) {
					str = str + '<div class="area10_11" onmouseover="$(\'.loupan'+data.data[i]['village_id']+'\').css(\'background-color\',\'#2b9225\');this.style.background=\'white\'" onmouseout="$(\'.loupan'+data.data[i]['village_id']+'\').css(\'background-color\',\'#EE5D5B\');this.style.background=\'#FAFAFA\'" ><span class="hei33 bold">'+data.data[i]['title']+'</span>&nbsp;[<a href="/rent/'+data.data[i]['id']+'.html" target="_blank" class="lan">详情</a>]<br> 物业类型：'+data.data[i]['type']+'<br>房型：'+data.data[i]['structure_1']+'室'+data.data[i]['structure_2']+'厅'+data.data[i]['structure_3']+'卫<br>面积：'+data.data[i]['size']+'m²<br>价格：'+data.data[i]['price']+'元</div>';
				}
