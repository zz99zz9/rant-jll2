...
<img src="xgwl/img/edtit.svg">
    ...
    <div class="searchbar">
        <div class="searchint" style="display:block;"><input class="sint" value="" type="text" id="skey"><button class="sbtn sxf" ><i class="mag"></i></button></div>
        <div class="searchint"><input class="sint" value="" type="text"  id="okey"><button class="sbtn s2sf" ><i class="mag"></i></button></div>
    </div>
</div>
<!--part1-->
...
loop
  ...
  <a class="morebtn" href="enrent.asp">MORE</a>
        </div>
    </div>
</div>
<!--part2-->
        ...
        <div class="part2">
        <p class="tit">For landlord</p>
        <p class="txt">Click the button of below</p>
        
       
        <a href="enfor-landlord.asp" class="morebtn tffy">psuh information</a>
        </div>
...
<div class="part3">
    <div class="container">
        <div class="row">
            <p class="ptit">Service process</p>
            <div class="hidden-sm"><img src="xgwl/img/rent/enGroup.png" class="group"></div>
