...
<input type="hidden" name="BigClassId" class="form-control" id="BigClassId"  >
 <input type="hidden" name="BAction" class="form-control" id="BAction" value="add">
          ...
          <div class="form-group">
    <label for="BigClassNameen" class="col-sm-3 control-label text-right">英文名称</label>
    <div class="col-sm-8">
<input type="text" name="BigClassNameen" class="form-control" id="BigClassNameen" data-toggle="tooltip" title="由英文、数字组成">
...
<input type="hidden" name="SmallClassId" class="form-control" id="SmallClassId"  >
 <input type="hidden" name="SAction" class="form-control" id="SAction" value="add">
  ...
  <div class="form-group">
    <label for="BigClassName" class="col-sm-3 control-label text-right">英文名称</label>
    <div class="col-sm-8">
    <input type="text" name="SmallClassNameen" class="form-control" id="SmallClassNameen" data-toggle="tooltip" title="由英文、数字组成">
    </div>
  </div>
    <div class="form-group">
...
<input type="hidden" name="XGCID" class="form-control" id="XGCID"  >
 ...
 <input type="hidden" name="XGTable" class="form-control" id="XGTable" />
      ...
      <div class="form-group">
    <label for="XGOID" class="col-sm-3 control-label text-right">英文名称</label>
    <div class="col-sm-8">
      <input type="text" name="XGCNameen" value="" class="form-control" id="XGCNameen" placeholder="" data-toggle="tooltip" title="由英文、数字组成">
    </div>
  </div>
