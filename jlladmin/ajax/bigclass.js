var BCName,BCNameen,BCId,OID,Action;
...
$(".save").click(function(){
	...
	BCNameen=$("#BigClassNameen").val();
	BCId=$("#BigClassId").val();
	Action=$("#BAction").val();
	OID=$("#OrderID").val();
	
	if (Action=="del"){$(this).attr("data-dismiss","modal");XgBigClass(BCName,BCNameen,Action,BCId,OID);}
	else{
 ...
 XgBigClass(BCName,BCNameen,Action,BCId,OID);//执行修改大类操作
	}
	}
})
/////////////////////////////////////
...
$(".ssave").click(function(){
	...
	if (SAction=="del"){$(this).attr("data-dismiss","modal");XgSmallClass(BCName,BCID,SCName,SCNameen,SCID,SAction,SOID);}
	else{
	if ($("#SmallClassName").hasClass("no")||$("#SmallClassName").val()==""||$("#SOrderID").hasClass("no")||$("#SOrderID").val()==""){
		...
		$(this).attr("data-dismiss","modal");//隐藏弹窗
 XgSmallClass(BCName,BCID,SCName,SCNameen,SCID,SAction,SOID,Szb);//执行修改小类操作
	}
	}
})
/////////////////////////////////////
//         小类修改传值给JSON         //
/////////////////////////////////////
function XgSmallClass(BCName,BCID,SCName,SCNameen,SCID,SAction,SOID,Szb){
		//ajax操作数据库
...
function defalutlist(v){
 ...
 XgBigClass(BCName,BCNameen,v,BCId,OID);
};

/////////////////////////////////////
//              输出列表大类         //
////////////////////////////////////
function XgBigClass(BCName,BCNameen,Action,BCId,OID){
	...
	str+='var bcnameen=$(this).data("bcnameen");';
	...
	str+='$("#BigClassNameen").val(bcnameen);';
	str+='$("#BAction").val("mod");';
...
str+='$("#xgbigclass").before("<p>是否确定要删除以下大类及相关产品信息吗？</p>");'
	...
	str+='$(".smod").click(function(){';
		...
		str+='var scnameen=$(this).data("scnameen");';
...
str+='}else if (saction=="mod"){';//修改小类
	...
	str+='$("#SmallClassNameen").val(scnameen);';
