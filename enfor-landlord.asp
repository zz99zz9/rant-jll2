...
<div class="part1 ">
        <div class="container container2">
            ...
            <div class="row">
                    ...
                    <div class="col-xs-12">
                    <h1 class="eloqua-heading">Want to serve？</h1>
                    </div>
                    </div>
                    <div class="row">
                    <div class="col-xs-12">
                    <p>Want to rent your property? Want to sell your office? Just fill out the form below or call us directly：</p>
                    ...
                    <div class="Form__line"> </div>
                          ...
                          <span class="panel-title fieldset-legend">Contact info</span>
                        </legend>
                              <div class="panel-body">
                            <div class="col-sm-2 form-item webform-component webform-component-select webform-component--contact-info-row1--salutation form-group form-item form-item-submitted-contact-info-row1-salutation form-type-select form-group"><select class="form-control form-select" id="edit-submitted-contact-info-row1-salutation" name="submitted[contact_info_row1][salutation]"><option value="Mr." selected="selected">Mr.</option><option value="Ms.">Ms.</option></select> <label class="control-label element-invisible" for="edit-submitted-contact-info-row1-salutation">Salutation</label>
                    </div><div class="col-sm-3 form-item webform-component webform-component-textfield webform-component--contact-info-row1--first-name form-group form-item form-item-submitted-contact-info-row1-first-name form-type-textfield form-group"><input placeholder="first name" class="Form__input form-control form-text" type="text" id="edit-submitted-contact-info-row1-first-name" name="submitted[contact_info_row1][first_name]" value="" size="60" maxlength="128" /> <label class="control-label element-invisible" for="edit-submitted-contact-info-row1-first-name">first name</label>
                    </div><div class="col-sm-3 form-item webform-component webform-component-textfield webform-component--contact-info-row1--last-name form-group form-item form-item-submitted-contact-info-row1-last-name form-type-textfield form-group"><input required="required" placeholder="last name" class="Form__input required form-control form-text required" type="text" id="edit-submitted-contact-info-row1-last-name" name="submitted[contact_info_row1][last_name]" value="" size="60" maxlength="128" /> <label class="control-label element-invisible" for="edit-submitted-contact-info-row1-last-name">last name <span class="form-required" title="This field is required.">*</span></label>
                    </div><div class="col-sm-4 form-item webform-component webform-component-textfield webform-component--contact-info-row1--company form-group form-item form-item-submitted-contact-info-row1-company form-type-textfield form-group"><input placeholder="company" class="Form__input form-control form-text" type="text" id="edit-submitted-contact-info-row1-company" name="submitted[contact_info_row1][company]" value="" size="60" maxlength="128" /> <label class="control-label element-invisible" for="edit-submitted-contact-info-row1-company">company</label>
                    </div>  </div>
                      </fieldset>
                    <fieldset  class="webform-component-fieldset row webform-component--contact-info-row2 panel panel-default form-wrapper">
                          <div class="panel-body">
                            <div class="col-sm-4 form-item webform-component webform-component-textfield webform-component--contact-info-row2--mobilePhone form-group form-item form-item-submitted-contact-info-row2-mobilephone form-type-textfield form-group"><input required="required" placeholder="tel*(+86xxxxxxxxxxx)" class="Form__input required form-control form-text required" type="text" id="edit-submitted-contact-info-row2-mobilephone" name="submitted[contact_info_row2][mobilePhone]" value="" size="60" maxlength="128" /> <label class="control-label element-invisible" for="edit-submitted-contact-info-row2-mobilephone">Tel <span class="form-required" title="This field is required.">*</span></label>
                    </div><div class="col-sm-4 form-item webform-component webform-component-email webform-component--contact-info-row2--email-address form-group form-item form-item-submitted-contact-info-row2-email-address form-type-webform-email form-group"><input required="required" class="email Form__input required form-control form-text form-email required" placeholder="email*" type="email" id="edit-submitted-contact-info-row2-email-address" name="submitted[contact_info_row2][email_address]" size="60" /> <label class="control-label element-invisible" for="edit-submitted-contact-info-row2-email-address">Email <span class="form-required" title="This field is required.">*</span></label>
                    </div><div class="col-sm-4 form-item webform-component webform-component-select webform-component--contact-info-row2--city form-group form-item form-item-submitted-contact-info-row2-city form-type-select form-group"><select class="form-control form-select" id="edit-submitted-contact-info-row2-city" name="submitted[contact_info_row2][city]"><option value="" selected="selected">City</option><option value="Shanghai">上海</option><option value="Beijing">Beijing</option><option value="Guangzhou">Guangzhou</option><option value="Chengdu">Chengdu</option><option value="Shenzhen">Shenzhen</option><option value="Other">Other</option></select> <label class="control-label element-invisible" for="edit-submitted-contact-info-row2-city">City</label>
                    </div>  </div>
                      </fieldset>
                    <fieldset  class="webform-component-fieldset row webform-component--building-info-row panel panel-default form-wrapper">
                              <legend class="panel-heading">
                          <span class="panel-title fieldset-legend">House information</span>
                        </legend>
                              <div class="panel-body">
                            <div class="col-sm-3 form-item webform-component webform-component-textfield webform-component--building-info-row--buildingname form-group form-item form-item-submitted-building-info-row-buildingname form-type-textfield form-group"><input placeholder="Community name" class="Form__input form-control form-text" type="text" id="edit-submitted-building-info-row-buildingname" name="submitted[building_info_row][buildingname]" value="" size="60" maxlength="128" /> <label class="control-label element-invisible" for="edit-submitted-building-info-row-buildingname">building name</label>
                    </div><div class="col-sm-3 form-item webform-component webform-component-textfield webform-component--building-info-row--unit form-group form-item form-item-submitted-building-info-row-unit form-type-textfield form-group"><input placeholder="Unit/floor" class="Form__input form-control form-text" type="text" id="edit-submitted-building-info-row-unit" name="submitted[building_info_row][unit]" value="" size="60" maxlength="128" /> <label class="control-label element-invisible" for="edit-submitted-building-info-row-unit">Unit</label>
                    </div><div class="col-sm-3 form-item webform-component webform-component-textfield webform-component--building-info-row--unitsize form-group form-item form-item-submitted-building-info-row-unitsize form-type-textfield form-group"><input placeholder="size" class="Form__input form-control form-text" type="text" id="edit-submitted-building-info-row-unitsize" name="submitted[building_info_row][unitsize]" value="" size="60" maxlength="128" /> <label class="control-label element-invisible" for="edit-submitted-building-info-row-unitsize">Size</label>
                    </div><div class="col-sm-3 form-item webform-component webform-component-textfield webform-component--building-info-row--rent form-group form-item form-item-submitted-building-info-row-rent form-type-textfield form-group"><input placeholder="rant/monthly" class="Form__input form-control form-text" type="text" id="edit-submitted-building-info-row-rent" name="submitted[building_info_row][rent]" value="" size="60" maxlength="128" /> <label class="control-label element-invisible" for="edit-submitted-building-info-row-rent">Rent</label>
                    </div>  </div>
                      </fieldset>
                    <fieldset  class="webform-component-fieldset row webform-component--your-message panel panel-default form-wrapper">
                              <legend class="panel-heading">
                          <span class="panel-title fieldset-legend">comments</span>
                        </legend>
                              <div class="panel-body">
                            <div class="col-sm-12 form-item webform-component webform-component-textarea webform-component--your-message--message form-group form-item form-item-submitted-your-message-message form-type-textarea form-group"><div class="form-textarea-wrapper"><textarea placeholder="comments" class="Form__input form-control form-textarea" id="edit-submitted-your-message-message" name="submitted[your_message][message]" cols="60" rows="5"></textarea></div> <label class="control-label element-invisible" for="edit-submitted-your-message-message">Your Message</label>
                    </div>  </div>
                      </fieldset>
                    ...
                    <div class="form-actions"><button class="olm-btn btn-danger olm-btn-small bbtn form-submit" type="submit" name="op" value="Submit">Submit</button>
